...
;(function () {
  ...
  function constructor (containerElOrString, config) {
    ...
    function snapbackDraggedPiece () {
      ...
      sourceSquarePosition.top -= $container.offset().top
      sourceSquarePosition.left -= $container.offset().left
    ...
    function dropDraggedPieceOnSquare (square) {
      ...
      targetSquarePosition.top -= $container.offset().top
      targetSquarePosition.left -= $container.offset().left
    ...
    function beginDraggingPiece (source, piece, x, y) {
      ...
      $draggedPiece.attr('src', buildPieceImgSrc(piece)).css({
        display: '',
        position: 'absolute',
        left: x - squareSize / 2 - $container[0].getBoundingClientRect().left,
        top: y - squareSize / 2- $container[0].getBoundingClientRect().top
      })
